...
const FULL_PANELS: Record<string, PanelConfig> = {
  ...
  deduction: { name: 'AI Forecast', enabled: true, priority: 1 },
  ...
  'supply-chain': { name: 'Supply Chain', enabled: false, priority: 1, ...(_desktop && { premium: 'enhanced' as const }) },
...
export const PANEL_CATEGORY_MAP: Record<string, { labelKey: string; panelKeys: string[]; variants?: string[] }> = {
  ...
  core: {
    ...
    panelKeys: ['map', 'live-news', 'live-webcams', 'insights', 'strategic-posture', 'deduction'],
  },
